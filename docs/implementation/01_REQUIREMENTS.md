...
2. Безопасно восстановить копию существующих данных и media для проверки.
...
- Если production backup недоступен, локальная проверка выполняется на минимальном согласованном наборе тестовых данных, но release блокируется до проверки реального контента.
